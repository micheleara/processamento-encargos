...
class S3FileDownloadClientTest {

    @Mock
    private S3Client s3Client;

    private S3FileDownloadClient criarAdapter(String bucketName, String s3KeyPrefix) throws Exception {
        S3Properties properties = new S3Properties();
        properties.setBucketName(bucketName);
        properties.setRegion("sa-east-1");

        S3FileDownloadClient adapter = new S3FileDownloadClient(s3Client, properties);
    ...
    void deveAbrirStreamDireto() throws Exception {
        S3FileDownloadClient adapter = criarAdapter("meu-bucket", "");
    ...
    void deveIncluirPrefixoNaChaveS3() throws Exception {
        S3FileDownloadClient adapter = criarAdapter("meu-bucket", "ambiente/");
